            ...
            <div class="col-lg-12 font-awesome-icons">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-lg-3 col-print-4">
                        ...
                        <i class="fa fa-fw" aria-hidden="true" title="Copy to use fat-backward"></i>
                        fa-fat-backward
                    ...
                    <div class="col-md-4 col-sm-6 col-lg-3 col-print-4">
                        ...
                        <i class="fa fa-fw" aria-hidden="true" title="Copy to use fat-forward"></i>
                        fa-fat-forward
                    ...
                    <div class="col-md-4 col-sm-6 col-lg-3 col-print-4">
                        <small class="text-muted pull-right">4.4</small>
                        <i class="fa fa-fw" aria-hidden="true" title="Copy to use safai"></i>
                        fa-safai
