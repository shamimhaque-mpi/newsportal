  ...
  function stringSearch (li, searchString, method, normalize) {
    ...
    for (var i = 0; i < stringTypes.length; i++) {
      ...
      if (string) {
        ...
        // Strip HTML tags. This isn't perfect, but it's much fater than any other method
  ...
  Selectpicker.prototype = {
      ...
      if (this.options.container) {
        ...
        this.$element.on('hide' + EVENT_KEY, function () {
          if (that.isVirtual()) {
            ...
            // replace the existing UL with an empty one - this is fater than $.empty() or innerHTML = ''
      ...
      function scroll (scrollTop, init) {
        ...
        if (init || positionIsDifferent) {
          ...
          if ((init || isVirtual === true) && menuIsDifferent) {
            ...
            // replace the existing UL with an empty one - this is fater than $.empty()
            menuInner.replaceChild(emptyMenu, menuInner.firstChild);
    ...
    setPlaceholder: function () {
      ...
      if (this.options.title && !this.multiple) {
        ...
        if (titleNotAppended) {
          // Use native JS to prepend option (fater)
    ...
    buildList: function () {
      ...
      function buildElement (item) {
        ...
        if (combinedLength > widestOptionLength) {
          ...
          // not perfect, but it's fat, and the width will be updating accordingly when scrolling
